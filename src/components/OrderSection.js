...
export default function OrderSection() {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Terima kasih! Pesanan Anda telah diterima. Tim kami akan menghubungi Anda segera.');
  };
      ...
      <div className="max-w-screen-xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto font-light text-gray-500 sm:text-xl">
            Diskusikan kebutuhan proyek Anda kepada kami, kami akan merekomendasikan produk yang tepat dan terbaik untuk Anda. Silahkan klik tombol dibawah ini untuk dapat terhubung secara langsung.
          </p>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16">
          ...
          {/* Quick Order Options */}
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Dapatkan Penawaran</h3>
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Telepon Langsung</h4>
                  <p className="text-gray-600">Hubungi untuk konsultasi langsung</p>
                </div>
              </a>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-4">Mengapa Memilih Kami?</h4>
