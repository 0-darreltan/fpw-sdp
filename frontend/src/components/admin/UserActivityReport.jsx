...
const UserActivityReport = () => {
  ...
  const { activityReport, loading, error } = useSelector((state) => state.user || {});
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-md">
          ...
          <div className="text-2xl font-bold mt-1">{stats?.totalUsers || 0}</div>
        </div>
        <div className="bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-lg shadow-md">
          <div className="text-sm opacity-90">Aktif (30 Hari)</div>
          <div className="text-2xl font-bold mt-1">{stats?.activeUsers30d || 0}</div>
        </div>
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-md">
          ...
          <div className="text-2xl font-bold mt-1">{stats?.activeUsers7d || 0}</div>
        </div>
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-lg shadow-md">
          ...
          <div className="text-2xl font-bold mt-1">{stats?.newUsers30d || 0}</div>
        </div>
        <div className="bg-gradient-to-br from-red-500 to-red-600 text-white p-6 rounded-lg shadow-md">
          ...
          <div className="text-2xl font-bold mt-1">{stats?.inactiveUsers || 0}</div>
        </div>
      </div>
