...
const OrderHistory = ({ orders, user }) => {
  ...
  // Filter orders for current customer - handle undefined orders and ensure it's an array
  const ordersArray = Array.isArray(orders) ? orders : [];
  const customerOrders = ordersArray.filter((order) => order.customerId === user?.id);
